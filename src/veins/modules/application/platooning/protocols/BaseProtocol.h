...
#include "veins/modules/application/platooning/messages/DENM_m.h"
...
class BaseProtocol : public BaseApplLayer {
	...
	private:
		...
		cOutVector distanceOut, relSpeedOut, nodeIdOut, speedOut, posxOut, posyOut, accelerationOut, desiredSpeedOut, desiredAccelerationOut;
	...
	public:
		...
		static const int DENM_TYPE = 30000;
