...
#include "veins/modules/application/platooning/scenarios/ManualDrivingScenario.h"

Define_Module(ManualDrivingScenario);

void ManualDrivingScenario::initialize(int stage) {
...
void ManualDrivingScenario::finish() {
	BaseScenario::finish();
}

void ManualDrivingScenario::handleSelfMsg(cMessage *msg) {
