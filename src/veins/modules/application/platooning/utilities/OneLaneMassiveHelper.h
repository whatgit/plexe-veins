...
#ifndef ONELANEMASSIVEHELPER_H_
#define ONELANEMASSIVEHELPER_H_
 ...
 */
class OneLaneMassiveHelper : public BasePositionHelper
{
	...
	public:
		OneLaneMassiveHelper() : BasePositionHelper() {
		}
